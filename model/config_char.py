...
class Config():
    ...
    filename_dev = "data_zh/dev-char.txt"
    filename_test = "data_zh/test-char.txt"
    filename_train = "data_zh/train-char.txt"

    max_iter = None # if not None, max number of examples in Dataset

    # vocab (created from dataset with build_data.py)
    filename_words = "data_zh/words-char.txt"
    filename_tags = "data_zh/tags-char.txt"
    filename_chars = "data_zh/chars-char.txt"
